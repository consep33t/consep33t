...
export default function ProfilePage() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen pt-28 pb-20 overflow-x-hidden relative font-sans">
      <Triangulation />

      <section className="mx-auto max-w-6xl px-6 sm:px-12 relative z-10">
        {/* Header */}
        <div className="mb-12 flex flex-col md:flex-row items-start md:items-end justify-between gap-6 profile-fade-up border-b border-white/10 pb-6">
          <div>
            ...
            <h1 className="font-display text-5xl md:text-6xl font-black uppercase tracking-widest text-white drop-shadow-[0_0_20px_rgba(0,240,255,0.4)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Left Column - ID Card */}
          <div className="col-span-1 md:col-span-4 space-y-8 profile-fade-up parallax-panel">
            <div className="glass-panel p-6 sm:p-8 hud-bracket relative group overflow-hidden shadow-[0_0_30px_rgba(0,240,255,0.08)]">
              {/* Animated Laser Line */}
              ...
              {/* Avatar Frame */}
              <div className="w-28 h-28 border-2 border-dashed border-signal-cyan/60 p-1 mb-6 relative mx-auto group-hover:border-signal-pink transition-colors duration-500">
                <div className="w-full h-full bg-signal-cyan/10 flex items-center justify-center relative overflow-hidden">
                  ...
                  <span className="font-display text-2xl font-black text-white relative z-10 tracking-widest">
                    AP
                  </span>
                </div>
                {/* HUD Elements */}
              ...
              <div className="text-center mb-6">
                <h2 className="font-display text-2xl font-black text-white mb-1 tracking-wider">
                  <GlitchText text="Ageng Prayoga" />
                </h2>
                <p className="font-mono text-xs text-signal-pink tracking-widest font-bold">
            ...
            <div className="glass-panel p-6 hud-bracket shadow-[0_0_20px_rgba(255,255,255,0.02)]">
              ...
              <div className="flex flex-wrap gap-2">
                {["React", "Next.js", "Vue", "Go", "Express.js", "Python", "FastAPI", "SQL Expert", "ESP32", "Sensors", "Cisco Network", "CI/CD"].map((skill) => (
                  <span 
                    key={skill} 
                    className="px-2.5 py-1 bg-white/5 border border-white/10 text-[11px] font-mono text-gray-300 hover:text-signal-cyan hover:border-signal-cyan transition-all cursor-pointer"
                  >
                    #{skill}
                  </span>
                ))}
          ...
          <div className="col-span-1 md:col-span-8 space-y-10">
            ...
            <div className="glass-panel p-6 sm:p-8 hud-bracket border-signal-cyan/40 hover:border-signal-cyan transition-all duration-300 group profile-fade-up">
              <h3 className="font-mono text-xl tracking-widest text-signal-cyan mb-4 flex items-center gap-3 font-bold">
                <span className="w-3.5 h-3.5 inline-block bg-signal-cyan/20 border border-signal-cyan rotate-45 group-hover:scale-125 transition-transform" />
                <GlitchText text="PROFIL_&_TUJUAN_KARIER" />
              </h3>
              <p className="font-sans text-sm md:text-base text-gray-300 leading-relaxed mb-4">
              ...
              <p className="font-sans text-sm md:text-base text-gray-300 leading-relaxed border-l-2 border-signal-pink pl-4 bg-signal-pink/5 py-2">
            ...
            <div className="glass-panel p-6 sm:p-8 hud-bracket border-signal-yellow/40 hover:border-signal-yellow transition-all duration-300 group profile-fade-up">
              <h3 className="font-mono text-xl tracking-widest text-signal-yellow mb-4 flex items-center gap-3 font-bold">
                <span className="w-3.5 h-3.5 inline-block bg-signal-yellow/20 border border-signal-yellow rotate-45 group-hover:scale-125 transition-transform" />
                <GlitchText text="PROYEK_SKRIPSI_AKADEMIK" />
              </h3>
              <div className="font-sans text-sm text-gray-300 space-y-3">
                ...
                <p className="text-xs font-mono text-signal-yellow">
            ...
            <div className="glass-panel p-6 sm:p-8 hud-bracket border-signal-pink/40 hover:border-signal-pink transition-all duration-300 group profile-fade-up">
              <h3 className="font-mono text-xl tracking-widest text-signal-pink mb-4 flex items-center gap-3 font-bold">
                <span className="w-3.5 h-3.5 inline-block bg-signal-pink/20 border border-signal-pink rotate-45 group-hover:scale-125 transition-transform" />
                <GlitchText text="LEADERSHIP_&_COMMUNITY" />
              </h3>
              <div className="space-y-4">
                <div className="border-b border-white/5 pb-3">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-mono text-sm font-bold text-white">Google Developer Group</h4>
                    <span className="font-mono text-xs text-signal-pink">2025 - Sekarang</span>
                  </div>
                  <p className="font-mono text-xs text-signal-cyan mb-1">Peserta Aktif (DevFest 2025, Code Fest 2026, Google Arcade)</p>
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-mono text-sm font-bold text-white">Hacktown Coder Competition</h4>
                    <span className="font-mono text-xs text-signal-pink">Januari 2025</span>
                  </div>
                  <p className="font-mono text-xs text-signal-cyan mb-1">Kompetitor (Innovers, Devfect, Infinite Learning)</p>
                  <p className="text-xs text-gray-300">
            ...
            <div className="glass-panel p-6 hud-bracket profile-fade-up border-signal-yellow/40">
              <div className="flex items-center justify-between pb-3 mb-4 border-b border-white/10 font-mono text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400 ml-2">// SYSTEM_CONSOLE_LOG</span>
                </div>
                <button
                  onClick={() => setTerminalIndex((prev) => (prev + 1) % TERMINAL_COMMANDS.length)}
                  className="text-signal-yellow hover:text-white transition-colors cursor-pointer px-2 py-0.5 border border-signal-yellow/30"
                >
                  [EXECUTE_NEXT_CMD ↵]
                </button>
              </div>

              <div className="font-mono text-xs text-gray-300 leading-relaxed space-y-2">
                <p>
                ...
                <p className="text-signal-yellow pl-4">
                  &gt; <DecryptedText text={TERMINAL_COMMANDS[terminalIndex].output} speed={25} />
                </p>
                <p className="text-green-400 pl-4">&gt; STATUS: EXECUTION_SUCCESSFUL [0 ERRORS]</p>
