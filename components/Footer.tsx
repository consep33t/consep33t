...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#08080C] px-6 py-12 relative overflow-hidden font-sans">
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 font-mono text-xs text-text-secondary md:flex-row">
        {/* Left Side */}
        <div className="flex flex-col items-center md:items-start gap-1">
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-signal-cyan animate-pulse shadow-[0_0_8px_#00F0FF]" />
            <GlitchText text="CONSEP33T // AGENG PRAYOGA" className="font-bold text-white tracking-widest text-sm" />
          </div>
          <p className="text-[11px] text-gray-500 font-jp tracking-widest">
        ...
        <button
          ...
          className="group inline-flex items-center gap-2 border border-signal-cyan/40 bg-signal-cyan/10 px-5 py-2 text-[11px] font-bold uppercase tracking-widest text-signal-cyan hover:border-signal-cyan hover:bg-signal-cyan hover:text-black transition-all duration-300 cursor-pointer shadow-[0_0_15px_rgba(0,240,255,0.15)]"
        >
