...
export default function Navigation() {
  ...
  return (
    ...
    >
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3 sm:py-3.5">
        {/* Brand */}
        <TransitionLink
          href="/"
          data-cursor="hover"
        ...
        {/* Desktop nav pill */}
        <div className="hidden md:flex items-center gap-1 p-1 border border-white/10 bg-black/60 backdrop-blur-md rounded-full shadow-inner">
          {NAV_LINKS.map((link) => {
        ...
        {/* Mobile hamburger — with proper size for tap targets */}
        <button
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden border-t border-signal-cyan/20 bg-[#06060A]/98 backdrop-blur-2xl overflow-hidden"
          >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className={`text-base transition-transform duration-300 ${isActive ? "translate-x-0 text-signal-cyan" : "-translate-x-1 text-gray-600 group-hover:translate-x-0"}`}>→</span>
                    </TransitionLink>
                  </motion.div>
                );
              })}
